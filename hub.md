...
schema: 1
type: note
name: "Notion inbox datacore Feed"
tagline: ""
description: |
...
attached_snippets:
  - path: "snippets/inbox-datacore-feed.css"
    name: "inbox-datacore-feed"
environment:
  obsidian_version: "unknown"
  theme: "Minimal"
  os: "Windows"
files:
  - path: "Releases/obsidianvaulthub/inbox-datacore-feed/Inbox Datacore Feed.md"
    type: md
    size: 7441
---
